...
public interface MapperInterface {
	...
	public int insCompanyInfo(AuthBean ab);
	public String isMember(AuthBean ab);
	public AuthBean isCompanyMember(AuthBean ab);
	public int insCompanyAuthLog(AuthBean ab);
	public int getCompanyAccessInfo(AuthBean ab);
	...
	//
	public AuthBean getMyInfo(String userCode);

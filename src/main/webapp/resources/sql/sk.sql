...
GROUP BY HD_CODE, HD_BBSUCODE, BB_NAME, WEIGHT, HEIGHT,HEAD,FOOT,TEMPERATURE, SLEEP, DEFECATION, DEFSTATUS,MEAL,MEMO;
SELECT  HD_CODE AS HDCODE,
        HD_BBSUCODE AS SUCODE,
        W1.WEIGHT AS WEIGHT,
        D7.DEFECATION AS DEFECATION
        FROM HD LEFT OUTER JOIN HDWEIGHT W1 ON W1.HDCODE = HD_CODE AND W1.SUCODE = HD_BBSUCODE 
                LEFT OUTER JOIN HDDEFECATION D7 ON D7.HDCODE = HD_CODE AND D7.SUCODE = HD_BBSUCODE
       where HD_CODE='100002' AND hd_bbsuCODE = '2410224488' group by hd_code, hd_bbsucode,weight,defecation;
